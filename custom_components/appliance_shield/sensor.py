...
from .const import (
    ...
    ATTR_SIGNATURE_READY,
    ATTR_STANDBY_POWER_W,
    ATTR_EWMA_DAILY_KWH,
    DOMAIN,
...
class ApplianceShieldHealthSensor(ApplianceShieldEntity):
    ...
    def extra_state_attributes(self) -> Dict[str, Any]:
        ...
        return {
            ...
            ATTR_CYCLE_STATE: diagnostics.cycle_state,
            ...
            ATTR_SIGNATURE_READY: diagnostics.signature_ready,
            ATTR_FEATURE_STATS: diagnostics.feature_stats,
            ATTR_STANDBY_POWER_W: diagnostics.standby_power_w,
        }
